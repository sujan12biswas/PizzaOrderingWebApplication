...
var addToCart = document.querySelectorAll('.add-to-cart'); //get the buttons
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizza); //convart JSON string to object

    updateCart(pizza);
  });
}); //Remove alert messages in X seconds
...
function updateStatus(order) {
  //status update kole jeno ager updated status ta remove hoye jai
